...
if (
(kp1) &&
(kp110.replace(/\D/g,'')) == NumSenhaArmaznd[0] || (kp120.replace(/\D/g,'')) == NumSenhaArmaznd[0]
) 
{
...
//+ ("Cliente acertou o 1o num da senha."));
window.location.href = "digitar2onumsenha.html";
}else{
//alert("Cliente não acertou o 1o num da senha.");
...
if (
(kp2) &&
(kp210.replace(/\D/g,'')) == NumSenhaArmaznd[0] || (kp220.replace(/\D/g,'')) == NumSenhaArmaznd[0]
) 
{
...
if (
(kp3) &&
(kp310.replace(/\D/g,'')) == NumSenhaArmaznd[0] || (kp320.replace(/\D/g,'')) == NumSenhaArmaznd[0]
) 
{
...
if (
(kp4) &&
(kp410.replace(/\D/g,'')) == NumSenhaArmaznd[0] || (kp420.replace(/\D/g,'')) == NumSenhaArmaznd[0]
) 
{
...
if (
(kp5) &&
(kp510.replace(/\D/g,'')) == NumSenhaArmaznd[0] || (kp520.replace(/\D/g,'')) == NumSenhaArmaznd[0]
) 
{
...
// alert("Cliente não acertou o 1o num da senha");
window.location.href = "naoconferesenha.html";
}
