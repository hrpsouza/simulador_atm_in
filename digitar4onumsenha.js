...
if (
(kp1) &&
(kp110.replace(/\D/g,'')) == NumSenhaArmaznd[3] || (kp120.replace(/\D/g,'')) == NumSenhaArmaznd[3]
) 
{
...
+ ("Cliente acertou os 4 num da senha."));
window.location.href = "../../../manutencao/manut.html";
}else{
alert("Cliente não acertou o 4o num da senha.");
...
if (
(kp2) &&
(kp210.replace(/\D/g,'')) == NumSenhaArmaznd[3] || (kp220.replace(/\D/g,'')) == NumSenhaArmaznd[3]
) 
{
...
if (
(kp3) &&
(kp310.replace(/\D/g,'')) == NumSenhaArmaznd[3] || (kp320.replace(/\D/g,'')) == NumSenhaArmaznd[3]
) 
{
...
if (
(kp4) &&
(kp410.replace(/\D/g,'')) == NumSenhaArmaznd[3] || (kp420.replace(/\D/g,'')) == NumSenhaArmaznd[3]
) 
{
...
if (
(kp5) &&
(kp510.replace(/\D/g,'')) == NumSenhaArmaznd[3] || (kp520.replace(/\D/g,'')) == NumSenhaArmaznd[3]
) 
{
