...
if (
(kp1) &&
(kp110.replace(/\D/g,'')) == NumSenhaArmaznd[1] || (kp120.replace(/\D/g,'')) == NumSenhaArmaznd[1]
) 
{
...
//+ ("Cliente acertou o 2o num da senha."));
window.location.href = "digitar3onumsenha.html";
}else{
//alert("Cliente não acertou o 2o num da senha.");
...
if (
(kp2) &&
(kp210.replace(/\D/g,'')) == NumSenhaArmaznd[1] || (kp220.replace(/\D/g,'')) == NumSenhaArmaznd[1]
) 
{
...
if (
(kp3) &&
(kp310.replace(/\D/g,'')) == NumSenhaArmaznd[1] || (kp320.replace(/\D/g,'')) == NumSenhaArmaznd[1]
) 
{
...
if (
(kp4) &&
(kp410.replace(/\D/g,'')) == NumSenhaArmaznd[1] || (kp420.replace(/\D/g,'')) == NumSenhaArmaznd[1]
) 
{
...
if (
(kp5) &&
(kp510.replace(/\D/g,'')) == NumSenhaArmaznd[1] || (kp520.replace(/\D/g,'')) == NumSenhaArmaznd[1]
) 
{
